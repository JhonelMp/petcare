...
const pool = new Pool({
    ...
    host: '172.22.35.247', // Dirección de tu servidor PostgreSQL
    database: 'petcare', // Nombre de tu base de datos
    password: '12345', // Contraseña del usuario
    port: 5432, // Puerto de PostgreSQL
    max: 10, // Máximo número de conexiones en el pool
    idleTimeoutMillis: 30000, // Tiempo en milisegundos antes de cerrar una conexión inactiva
    connectionTimeoutMillis: 30000 // Tiempo máximo para conectar antes de lanzar un error
});
